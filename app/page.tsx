  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="max-w-4xl mx-auto px-6 py-20 text-center">
        <h1 className="text-4xl md:text-5xl font-bold mb-4">PropCare - Landlord Maintenance Manager</h1>
        <p className="text-xl text-gray-600 mb-8 max-w-2xl mx-auto">Value Proposition: Solves landlords' improper communication/scheduling of maintenance. Centralized platform for tenant requests, automated scheduling, and contractor coordination. Reduces frustrations, delays, and improves tenant satisfaction.
...
Promotion Type: automatic</p>
      ...
      <section className="max-w-4xl mx-auto px-6 py-20 text-center">
        ...
        <p className="text-gray-600 mb-6">Join thousands of small businesses who trust PropCare - Landlord Maintenance Manager.</p>
      ...
      <footer className="border-t py-8">
        <div className="max-w-4xl mx-auto px-6 flex justify-between text-sm text-gray-500">
          <p>© {new Date().getFullYear()} PropCare - Landlord Maintenance Manager. All rights reserved.</p>
